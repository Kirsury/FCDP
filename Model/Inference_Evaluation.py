...
print(f"✅ 加载测试数据集...")
source_test_data = load_jsonlines(test_path)

train_codes = {line['code'] for line in train_data}
test_data = [line for line in source_test_data if line['code'] not in train_codes]
...
model.load_state_dict(torch.load('model.pt', map_location='cpu'))  # 加载参数到CPU
